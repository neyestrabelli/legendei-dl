 ...
 * @returns {Deferred.promise}
 */
 Utils.fetchSubtitle = function (legendei,path, subject, subjectList, originalFiles) {
     ...
     var tmpFile = tmpPath + realpath.basename(subject);

     var params = {subject: subject, file: tmpFile, subjectList: subjectList, originalFiles: originalFiles};
         legendei.search(params)
         .then(legendei.openURL)
         .then(legendei.saveFile)
         .then(Utils.extract)
         .then(def.resolve)
